...
public class Register extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etReenter = findViewById(R.id.ETreenterpassword);
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(etName.getText().toString().isEmpty()
                    ...
                    Toast.makeText(Register.this, "Enter all info", Toast.LENGTH_SHORT).show();
                } else{
                    if(etPassword.getText().toString().equals(etReenter.getText().toString())){
                        ...
                        Toast.makeText(Register.this, "Make sure that both passwords match", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
